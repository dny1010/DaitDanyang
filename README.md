...
PetShop은 **반려동물 쇼핑몰 기능과 사용자 커뮤니티, 챗봇을 이용하여 자사의 상품 연결 및 대화기능 을 결합한 웹 서비스**입니다.  
...
## 🤝 같이 개발한 팀원들
🐻 이  호 : 데이터 수집, DB구성, 백 구성, 프론트 및 api구성 <br>
🐱 박선영 : 프론트 구성, 백 구성  PPT, 발표 <br>
🐥 이다미 : 데이터 수집, 프론트 구성, PPT <br>  
🐵 김태훈 : 프론트구성 <br>
🦁 빙승현 : 프론트구성, 데이터 수집, 벡터 DB구성 <br>
...
🐱 박선영 : 프론트 구성, 백 구성  PPT, 발표<br>
🐥 이다미 : 이번 프로젝트를 통해 단순한 기능 구현을 넘어,
            실제 서비스 구조와 개발 흐름을 이해하는 경험을 했다.  <br>
🐵 김태훈 : 프론트구성<br>
🦁 빙승현 : 프론트구성, 데이터 수집, 벡터 DB구성<br>
